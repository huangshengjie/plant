# Generated by Django 2.1.4 on 2019-04-07 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='application.Gallery', verbose_name='相册id')),
            ],
            options={
                'verbose_name': '照片',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(default='', max_length=100, verbose_name='植物头像')),
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='application.Category', verbose_name='植物类别id')),
            ],
            options={
                'verbose_name': '植物',
